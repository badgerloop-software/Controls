...
void MPU9250::getAccelAll(float *data , bool scale ) {
    ...
    if(scale) {
      if (currentAcceleroRange == MPU9250_ACCELERO_RANGE_2G) {
          data[0]=data[0] / 16384.0f * 9.81f;
          data[1]=data[1] / 16384.0f * 9.81f;
          data[2]=data[2] / 16384.0f * 9.81f;
      }
      if (currentAcceleroRange == MPU9250_ACCELERO_RANGE_4G){
          data[0]=data[0] / 8192.0f * 9.81f;
          data[1]=data[1] / 8192.0f * 9.81f;
          data[2]=data[2] / 8192.0f * 9.81f;
      }
      if (currentAcceleroRange == MPU9250_ACCELERO_RANGE_8G){
          data[0]=data[0] / 4096.0f * 9.81f;
          data[1]=data[1] / 4096.0f * 9.81f;
          data[2]=data[2] / 4096.0f * 9.81f;
      }
      if (currentAcceleroRange == MPU9250_ACCELERO_RANGE_16G){
          data[0]=data[0] / 2048.0f * 9.81f;
          data[1]=data[1] / 2048.0f * 9.81f;
          data[2]=data[2] / 2048.0f * 9.81f;
      }
    }
...
float MPU9250::getTempScaled( void ) {
    ...
    retval=(retval+521.0f) / 340.0f + 35.0f;
    return retval;
}
